...
* The IOPMP uses the RRID to look up the SRCMD Table and identify the memory domains associated with the requester.
* The IOPMP uses the associated memory domains to look up the MDCFG Table and identify the entries belonging to those memory domains.
