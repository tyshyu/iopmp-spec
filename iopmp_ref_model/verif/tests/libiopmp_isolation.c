/***************************************************************************
// libiopmp tests for the Isolation Model: SRCMD_FMT=1 & MDCFG_FMT=0.
//
// RRID s is hardwired to MD s, so there is no SRCMD table. The MDCFG table
// is a real one, which is what separates this model from Compact-k.
***************************************************************************/
...
int main(void)
{
    ...
    START_TEST("Initialize the Isolation Model");
