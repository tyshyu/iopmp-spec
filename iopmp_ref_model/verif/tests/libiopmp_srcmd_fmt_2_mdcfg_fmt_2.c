/***************************************************************************
// libiopmp tests for SRCMD_FMT=2 & MDCFG_FMT=2.
//
// SRCMD_EN(H) is replaced by the MD-indexed SRCMD_PERM(H), and there is
// no MDCFG table: the entries each MD owns are programmable through
// HWCFG3.md_entry_num.
***************************************************************************/
...
int main(void)
{
    ...
    START_TEST("Initialize SRCMD_FMT=2 & MDCFG_FMT=2");
