/***************************************************************************
// libiopmp tests for the Rapid-k Model: SRCMD_FMT=0 & MDCFG_FMT=1.
//
// The baseline SRCMD_EN(H) table is there, but there is no MDCFG table:
// every MD owns a fixed HWCFG3.md_entry_num+1 entries.
***************************************************************************/
...
int main(void)
{
    ...
    START_TEST("Initialize the Rapid-k Model");
