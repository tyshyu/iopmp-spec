...
For 0 &#x2264; _m_ &#x2264; 30, `MDLCK.md[_m_]` locks `SRCMD_PERM(_m_)` and `SRCMD_PERMH(_m_)`, if implemented. For 0 &#x2264; _m_ &#x2264; 31, `MDLCKH.mdh[_m_]` locks `SRCMD_PERM(_m_ + 31)` and `SRCMD_PERMH(_m_ + 31)`, if implemented.
