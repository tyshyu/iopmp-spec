 ...
 */
#define VENDOR_EXAMPLE_IMPID            0xA5A5A5A5
 ...
 */
#define VENDOR_ENTRYLCK_BASE            0x00c0
    #define VENDOR_ENTRYLCK_L_SHIFT     0
    #define VENDOR_ENTRYLCK_L_MASK      GENMASK_32(0, 0)
    #define VENDOR_ENTRYLCK_F_SHIFT     1
    #define VENDOR_ENTRYLCK_F_MASK      GENMASK_32(16, 1)
